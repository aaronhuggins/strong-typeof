 ...
 */
export function StrongFunction<T>(types: Array<Type | Type[]>, fn: FunctionLike<any, T>): FunctionLike<any, T>
export function StrongFunction<T>(types: Array<Type | Type[]>, fn: AsyncFunctionLike< any, T>): AsyncFunctionLike<any, T>
export function StrongFunction<T>(types: Array<Type | Type[]>, fn: FunctionLike<any, T> | AsyncFunctionLike< any, T>): FunctionLike<any, T> | AsyncFunctionLike<any, T> {
 ...
 */
export function WeakFunction<A, T>(type: Type | Type[], fn: FunctionLike<A, T>): FunctionLike<A, T>
export function WeakFunction<A, T>(type: Type | Type[], fn: AsyncFunctionLike<A, T>): AsyncFunctionLike<A, T>
export function WeakFunction<A, T>(type: Type | Type[], fn: FunctionLike<A, T> | AsyncFunctionLike<A, T>): FunctionLike<A, T> | AsyncFunctionLike<A, T> {
  if (!isType(fn, 'function', 'asyncfunction')) throw new TypeError('Argument fn is required and must be a function.')
  const self = this
